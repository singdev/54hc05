...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/medileaf/cost-calculator.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Oct 2020 10:00:43 GMT -->
  ...
  <body>
        ...
        <div class="row align-items-center intro-title">
          <div class="col-12">
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item active"> <i class="fas fa-chevron-right"></i> <span> Paiement de la Facture </span></li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-10">
            <div class="blood">
              <h4 class="mb-4">Paiement de la <?php echo $libelle;?></h4>
                <div class="row align-items-center">
                <?php 
                    echo '<div class="form-group select-border col-md-12"> - Nom : BABICKA <br></div>';
                    echo '<div class="form-group select-border col-md-12">- Prenom : Delia <br></div>';
                    echo '<div class="form-group select-border col-md-12"><b> Montant à payer : '.$montant.'F</b> <br><br></div>';
                ?>
                </div>
            </div>

            <div class="blood">
              <h4 class="mb-4" style="color:red">Paiement via Airtel Money</h4>
                    <form class="mt-5">
                        <div class="row align-items-center">
                    ...
                    <div class="col-sm-12 mb-0">
                        <button class="btn btn-outline-primary" onclick="payer()">Valider</button>
                    </div>
                    <br>
                    <p style="color:green" id="text_payer"></p>
            </div>
            
            <div class="blood">
              <h4 class="mb-4" style="color:orange">Paiement via Mobi Cash</h4>
                    <form class="mt-5">
                        <div class="row align-items-center">
                        <div class="form-group col-md-6">
                            <input type="text" class="form-control" id="" name="" placeholder="Telephone">
                    ...
                    <div class="col-sm-12 mb-0">
                        <button class="btn btn-outline-primary" onclick="payer2()">Valider</button>
                    </div>
                    <br>
                    <p style="color:green" id="text_payer2"></p>
            </div>
    ...
    <script>
        function payer() {
            document.getElementById('text_payer').innerHTML='Paiement validé !';
        }
        function payer2() {
            document.getElementById('text_payer2').innerHTML='Paiement validé !';
        }
    </script>
