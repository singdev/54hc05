      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-10">
            <div class="blood">
              <h4 class="mb-4">Historique de Consultations</h4>
                <div class="row align-items-center">
                <?php
                    echo '<div class="form-group select-border col-md-12">- Structure : '.$structure.' <br></div>';
                    echo '<div class="form-group select-border col-md-12">- Spécialité : '.$specialite.' <br></div>';
                    echo '<div class="form-group select-border col-md-12">- Medecin : '.$medecin.' <br></div>';
                    echo '<div class="form-group select-border col-md-12">- Jour : 24/10/2020 <br></div>';
                ?>
                </div>
            </div>
            <div class="text-right">
              <span class="blood-total">Total</span>
              <span class="blood-amount">15000F</span>
            </div>
            <br>
            <div class="add-listing d-sm-block">
                <?php
                    echo '<a class="btn btn-outline-primary" href="ecran4.php?valide&libelle=Consultation&montant=15000"><i class="fa fa-file"></i>Payer la Consultation</a>';
                ?>
            </div>
            <br>
          </div>
